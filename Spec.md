...
If supplied, and allowed by the **license** field, users may OPT-IN to
downloading the mod via a bittorrent application, rather than strictly
downloading from the provided **download** url. The **download** url will be
used as an alternative source in the generated magnet link.
