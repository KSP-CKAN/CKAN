...
namespace CKAN
{
    public partial class ManageKspInstancesDialog : Form
    {
        ...
        public ManageKspInstancesDialog(bool centerScreen, IUser user)
        {
        ...
        private void AddToCKANMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                KSP instance = new KSP(path, instanceName, _user);
                _manager.AddInstance(instance);
                UpdateInstancesList();
            }
            catch (NotKSPDirKraken k)
            {
                _user.RaiseError(Properties.Resources.ManageKspInstancesNotValid,
                    new object[] { k.path });
                return;
            }
        }
        ...
        private void CloneFakeInstanceMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var result = new CloneFakeKspDialog(_manager, _user).ShowDialog();
        ...
        private void UseSelectedInstance()
        {
            ...
            {
                _user.RaiseError(Properties.Resources.ManageKspInstancesNotValid, k.path);
            }
        }
        ...
        private void OpenDirectoryMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                _user.RaiseError(Properties.Resources.ManageKspInstancesDirectoryDeleted, path);
                return;
            }
