            ...
            if (json.ContainsKey("install"))
            {
                                                          ...
                                                          ?? Enumerable.Empty<JObject>())
                {
                    ...
                    foreach (string propName in pathProperties)
                    {
                        ...
                        {
                            var val = (string?)stanza[propName];
